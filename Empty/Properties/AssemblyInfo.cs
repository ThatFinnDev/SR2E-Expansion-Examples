...
{
    internal const string Name = "Example ExpansionV3"; // Name of the Expansion.
    internal const string Description = "This is an empty example expansion for SR2E"; // Description for the Expansion.
