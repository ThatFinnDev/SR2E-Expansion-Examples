...
{
    internal const string Name = "Menu Example"; // Name of the Expansion.
    internal const string Description = "This adds an example menu"; // Description for the Expansion.
