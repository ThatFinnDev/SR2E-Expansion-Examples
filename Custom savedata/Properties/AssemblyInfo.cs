...
internal static class GetEntrypointType { public static System.Type type => typeof(ExampleExpansion.ExampleExpansionEntrypoint); }

// BuildInfo
internal static class BuildInfo
{
    internal const string Name = "Custom save data example"; // Name of the Expansion.
    internal const string Description = "This is an example expansion showing how custom save data in save files work"; // Description for the Expansion.
